...
### Rendu du TP
Vous devez m'envoyer par mail à l'adresse `mme.k......@z......net`
que vous connaissez (et que je n'écris pas pour éviter les spams)
votre code sous la forme de 6 fichiers : `bonjour.c`, `bonjour.ml`,
`point.c`, `point.ml`, `bresenham.c`, `bresenham.ml`. Merci de bien
respecter les noms des fonctions demandées ainsi que l'ordre et les
