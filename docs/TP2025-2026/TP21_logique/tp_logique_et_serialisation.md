...
un fichier au format dimacs. Dans ce format les variables
propositionnelles sont représentées par des entiers strictement
positifs. Le littéral négatif associé à une variable propositionnelle
est donné par l'opposé de la valeur représentant la variable.
...
* tout membre écossais porte des chaussures rouges ;
...
**Question 9.** Passer une formule sous forme normale conjonctive sur [learn-ocaml](http://vps-ff29e1ab.vps.ovh.net/).
