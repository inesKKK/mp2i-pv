TP27 : Bases de données -- suite
==

On repart de la situation du [tp26](../TP26_BD1/tp_bd1.md). Rappel:
pour vous connecter à la base sur laquelle nous travaillons, vous
devez utiliser la ligne de commande `psql communes utilisateur` (sur
