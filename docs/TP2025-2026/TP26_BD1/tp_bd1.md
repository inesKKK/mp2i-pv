TP26 : Bases de données 1
==

Tous les fichiers nécessaires sont installés sur les machines de la
salle de TP.

Ceux qui voudraient faire le TP sur leur propre machine
...
```bash
psql communes utilisateur      # il faut bien écrire utilisateur ici
```
