...
la grille. Pour rappel, le format dimacs est décrit dans le [tp21](https://ineskkk.github.io/mp2i-pv/TP2025-2026/TP21_logique/tp_logique_et_serialisation.html).
...
grille grâce à un fichier contenant une ligne par case initialement
