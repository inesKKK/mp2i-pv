...
**Exercice 9**:
Implémentez une autre méthode de calcul de la racine carré choisie sur
la [page wikipedia consacrée au calcul de la racine carrée](https://fr.wikipedia.org/wiki/Extraction_de_racine_carr%C3%A9e).
