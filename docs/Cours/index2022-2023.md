...
**5 janvier 2023**
* files de priorité
* implémentation par tas max : percolation vers le bas (correction et complexité)
...
* tri rapide - suite : complexité dans le pire des cas, le
    meilleur des cas et en moyenne, cas des doublons; code : [tri_rapide_3.c](code/tri_rapide_3.c)
